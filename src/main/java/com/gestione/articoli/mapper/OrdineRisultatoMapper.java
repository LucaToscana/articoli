...
public class OrdineRisultatoMapper {
	...
	public static OrdineRisultatoDto toDto(OrdineRisultato entity) {
	    return OrdineRisultatoDto.builder()
	            ...
	            .prezzoOrarioFisso(entity.getPREZZO_ORARIO_FISSO())
	            .costoOrarioFisso(entity.getCOSTO_ORARIO_FISSO())
	            .costoPersonaleOrarioMedio(entity.getCOSTO_PERSONALE_ORARIO_MEDIO())
	            .ivaStandard(entity.getIVA_STANDARD())
	...
	public static OrdineRisultato toEntity(OrdineRisultatoDto dto) {
	    ...
	    return OrdineRisultato.builder()
	            ...
	            // 🔹 Parametri di calcolo
	            .PREZZO_ORARIO_FISSO(dto.getPrezzoOrarioFisso())
	            .COSTO_ORARIO_FISSO(dto.getCostoOrarioFisso())
	            .COSTO_PERSONALE_ORARIO_MEDIO(dto.getCostoPersonaleOrarioMedio())
	            .IVA_STANDARD(dto.getIvaStandard())
	            .RICARICO_BASE(dto.getRicaricoBase())
	            .build();
	}
}
