...
public class OrdineRisultato {
	...
	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal staccareReale = BigDecimal.ZERO;

	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal staccareFatturabile = BigDecimal.ZERO;
	...
	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal lavareReale = BigDecimal.ZERO;

	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal lavareFatturabile = BigDecimal.ZERO;
	...
	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal annerireReale = BigDecimal.ZERO;

	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal annerireFatturabile = BigDecimal.ZERO;
	...
	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal satinareReale = BigDecimal.ZERO;

	@Column(nullable = false, precision = 38, scale = 4)
	@Builder.Default
	private BigDecimal satinareFatturabile = BigDecimal.ZERO;
	...
	public static OrdineRisultato createEmpty(Ordine ordine, Articolo articolo, BigDecimal prezzo) {
		return OrdineRisultato.builder().ordine(ordine).articolo(articolo)
				.prezzo(prezzo != null ? prezzo : BigDecimal.ZERO).molaturaReale(BigDecimal.ZERO)
				.molaturaFatturabile(BigDecimal.ZERO).lucidaturaReale(BigDecimal.ZERO)
				.lucidaturaFatturabile(BigDecimal.ZERO).saldaturaReale(BigDecimal.ZERO)
				.saldaturaFatturabile(BigDecimal.ZERO).foraturaReale(BigDecimal.ZERO)
				.foraturaFatturabile(BigDecimal.ZERO).filettaturaReale(BigDecimal.ZERO)
				.filettaturaFatturabile(BigDecimal.ZERO).montaggioReale(BigDecimal.ZERO)
				.montaggioFatturabile(BigDecimal.ZERO).scatolaturaReale(BigDecimal.ZERO)
				.scatolaturaFatturabile(BigDecimal.ZERO).staccareReale(BigDecimal.ZERO)
				.staccareFatturabile(BigDecimal.ZERO).lavareReale(BigDecimal.ZERO).lavareFatturabile(BigDecimal.ZERO)
				.annerireReale(BigDecimal.ZERO).annerireFatturabile(BigDecimal.ZERO).satinareReale(BigDecimal.ZERO)
				.satinareFatturabile(BigDecimal.ZERO).quantita(BigDecimal.ZERO).dataRisultato(LocalDateTime.now())
				.build();
	}

	@Override
	public String toString() {
		return "OrdineRisultato{" + "id=" + id + ", ordineId=" + (ordine != null ? ordine.getId() : null)
				+ ", articoloId=" + (articolo != null ? articolo.getId() : null) + ", quantita=" + quantita
				+ ", prezzo=" + prezzo + '}';
	}
}
